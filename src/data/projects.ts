...
export interface Project {
  name: string;
  year: number;
  // Whether the /thinking agent (scout/reviewer) may reference this project by
  // name. NOT the same as public: a project can be a public card here and still
  // be off limits to the agent. This is the allowlist the agent reads.
  agentReferenceable: boolean;
  oneliner: string;
  stack: string[];
  body: string;
  links?: ProjectLink[];
